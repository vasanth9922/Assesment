...
import Chains_Rattling from './Chains_Rattling.wav'
import Pen_Clicks from './Pen_Clicks.wav'

class ButtonSliderSecond extends React.Component {
    ...
    constructor(props) {
        ...
        this.click1 = new Audio(Chains_Rattling);
        this.click2 = new Audio(Pen_Clicks);
    }
...
export default ButtonSliderSecond;